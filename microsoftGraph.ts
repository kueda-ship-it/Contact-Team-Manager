...
if (!tenantId || tenantId === 'undefined') {
    console.error("CRITICAL: VITE_AZURE_TENANT_ID is missing! Please check your .env file and restart the dev server (npm run dev).");
}
if (!clientId || clientId === 'undefined') {
    console.error("CRITICAL: VITE_AZURE_CLIENT_ID is missing! Please check your .env file and restart the dev server (npm run dev).");
}
